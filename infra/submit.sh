...
# echo "~/mae_jax/infra/wrapper.sh mae $salt 128 base imagenet-1k --config.lr_schedule=linear" >> $queue_file
# echo "~/mae_jax/infra/wrapper.sh mae $salt 256 base imagenet-1k --config.lr_schedule=linear --config.num_epochs=1600" >> $queue_file

# echo "~/mae_jax/infra/wrapper.sh mae $salt 128 large imagenet-1k --config.lr_schedule=linear" >> $queue_file
# echo "~/mae_jax/infra/wrapper.sh mae $salt 256 large imagenet-1k --config.lr_schedule=linear --config.num_epochs=1600" >> $queue_file

# echo "~/mae_jax/infra/wrapper.sh mae $salt 256 huge imagenet-1k --config.lr_schedule=linear" >> $queue_file
# echo "~/mae_jax/infra/wrapper.sh mae $salt 512 huge imagenet-1k --config.lr_schedule=linear --config.num_epochs=1600" >> $queue_file
