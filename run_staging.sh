...
JOBNAME=flax/$(date +%Y%m%d_%H%M%S)_${VM_NAME}_${CONFIG}_${ep}ep_maeDBG_batch${batch}_lr${lr}_vmap_NOnormpix_sincos_initmaev2_cropvc_donate_olkNN_NOexClsDBG_masknoise_qkv_buf16x1024_noavelog_seed
