...
# iNat 2018: 437513 sample. 15 * 1281167 / 437513 == 44ep
...
JOBNAME=flax/${name}_finetune/$(date +%Y%m%d_%H%M%S)_${VM_NAME}_${CONFIG}_${ep}ep_fttl_iNat${version}_b${batch}_wd${wd}_lr${lr}_lrd${lrd}_pdp${pdp}_dp${dp}_warm${warm}_s${seed}_beta${beta2}_p${partitions}st_stop${stopg}_pred${pft}_act2_param2_im${im_sz}
RESUME=''
