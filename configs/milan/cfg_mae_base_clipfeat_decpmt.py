...
def get_config():
    ...
    config.model.model_img_feat.update(vit.get_b16_config())
    ...
    config.model.model_img_feat.transformer.proj_dim = 512
    ...
    config.model.model_txt_feat.name = 'ViT-B_16'
    config.model.model_txt_feat.proj_dim = 512
    config.model.model_txt_feat.width = 512
    config.model.model_txt_feat.heads = 8
