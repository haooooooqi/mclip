...
def get_config():
  ...
  # ViT-GPT-10B
  # https://docs.google.com/spreadsheets/d/1BxImqKJrkIbf8nnzb7O7-Z6lsPX_y-LnVKoEp0fT6Lc/edit#gid=1516667488
  config.model.update(vit.get_h14_config())
  config.model.transformer.num_layers = 96
  config.model.transformer.num_heads = 80
  config.model.hidden_size = 10240
  config.model.transformer.mlp_dim = 10240 * 4
  ...
  config.model.transformer.remat_policy = "full"

  # same decoder as in ViT-L/16
  ...
  config.model.decoder.transformer.remat_policy = "full"
