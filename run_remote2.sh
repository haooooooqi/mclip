...
JOBNAME=flax/$(date +%Y%m%d_%H%M%S)_${VM_NAME}_${CONFIG}_maetf_${ep}ep_b${batch}_lr${lr}_wd${wd}_mask${mask}_TorchLoader_wseed${seed}_gumbel${vocab}_klw${klw}_t${tau}_lossall
RESUME_DIR=''
