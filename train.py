...
import models_mae, models_mclr, models_maco, models_mv3, models_cder
...
def train_and_evaluate(config: ml_collections.ConfigDict,
  ...
  elif config.model_type == 'mv3':
    model = models_mv3.SiameseLearner(image_size=config.image_size, **config.model)
  elif config.model_type == 'cder':
    model = models_cder.SiameseLearner(image_size=config.image_size, **config.model)
  else:
