...
JOBNAME=flax/${name}_finetune/$(date +%Y%m%d_%H%M%S)_${VM_NAME}_${CONFIG}_${ep}ep_fttl_b${batch}_wd${wd}_lr${lr}_lrd${lrd}_pdp${dp}_warm${warm}_s${seed}_beta${beta2}_p${partitions}_pft768x12_token_pred_NOposemb
