...
JOBNAME=flax/$(date +%Y%m%d_%H%M%S)_${VM_NAME}_${CONFIG}_autoreg_${ep}ep_b${batch}_lr${lr}_TorchLoader_wseed${seed}_NOnormpix_ohem${ohem}_off${offset}_dec${dec_layers}_row
RESUME_DIR=''
