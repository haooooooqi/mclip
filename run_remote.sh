...
JOBNAME=flax/$(date +%Y%m%d_%H%M%S)_${VM_NAME}_${CONFIG}_maetf_${ep}ep_b${batch}_lr${lr}_mask${mask}_TorchLoader_wseed${seed}_gumbel${vocab}_klw${klw}_t${tau}_hard
RESUME_DIR=''
...
python3 main.py \
    ...
    --config.model.gumbel.softmax_only=False \
