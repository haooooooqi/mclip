...
python3 main.py \
    ...
    --config.pretrain_dir='gs://kmh-gcp/checkpoints/flax/20220816_010427_maet5x_kmh-tpuvm-v3-256-4_cfg_mae_large_800ep_b4096_lr1e-4_mk0.75txt0.25_s100_p1st_re1.0_laion_a0.5_sanity_twoMAE_removecall' \
