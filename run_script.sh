...
python3 main.py \
    ...
    --config.pretrain_dir='gs://kmh-gcp/checkpoints/flax/20220810_060227_kmh-tpuvm-v3-256-3_cfg_clr_base_simclr_300ep_b4096_lr1e-4_wd0.1_TorchLoader_wseed100_t0.2'
