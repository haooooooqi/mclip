...
python3 main.py \
    ...
    --config.resume_dir='gs://kmh-gcp/checkpoints/flax/20220526_202820_scratch_kmh-tpuvm-v3-256-4_cfg_vit_large_50ep_fttl_b1024_wd0.3_lr1e-4_lrd1.0_dp0.2_warm20_s0_beta0.95_p4_save1'
